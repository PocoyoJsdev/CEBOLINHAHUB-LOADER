...
-- ╚══════════════════════════════════════════╝
-- Verificação removida: a key é validada pelo loader via PandaDevelopment
...
-- print("--------------------------------------------------------------------------");
local Update = (loadstring(game:HttpGet("https://cebolinha-hub-blox.vercel.app/fruitsource.lua?key=8186a7a7fc38c24d9a43c93637f6c0933fbdae0394b9c6ac")))();
